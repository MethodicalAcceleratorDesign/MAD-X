...
numdiff_test(test-cororbit 0)
numdiff_test(test-cororbit-2 0)
...
numdiff_test(test-ibs-4 0)
numdiff_test(test-error 0)
numdiff_test(test-error-2 0)
numdiff_test(test-dynap 1)
numdiff_test(test-c6t 0)
set_tests_properties(test-c6t PROPERTIES DEPENDS test-makethin-2_LONG)
...
numdiff_test(test-ptc-twiss-old1 0)
numdiff_test(test-ptc-twiss-old2 0)
numdiff_test(test-ptc-twiss-old3 0)
numdiff_test(test-ptc-twiss-old4 0)
numdiff_test(test-ptc-twiss-old5 0)
if(NOT WIN32)
   numdiff_test(test-ptc-twiss-old6 1)
endif()
numdiff_test(test-ptc-twiss-old7 1)
numdiff_test(test-ptc-twiss-5D 0)
numdiff_test(test-ptc-twiss-56D 0)
numdiff_test(test-ptc-twiss-56Dt 0)
numdiff_test(test-ptc-twiss-56Dl 0)
numdiff_test(test-ptc-twiss-56Dtl 0)
