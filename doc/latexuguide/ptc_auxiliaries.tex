...
\begin{itemize}
   \item \hyperref[sec:ptc-setswitch]{\tt PTC\_SETSWITCH}
   \item \hyperref[sec:ptc-knob]{\tt PTC\_KNOB}
   \item \hyperref[sec:ptc-setknobvalue]{\tt PTC\_SETKNOBVALUE}
   \item {\tt MATCH\_WITHPTCKNOBS} \qquad {\bf (Under Construction)} 
   \item \hyperref[sec:ptc-printparametric]{\tt PTC\_PRINTPARAMETRIC}
   \item \hyperref[sec:ptc-eplacement]{\tt PTC\_EPLACEMENT}
   \item \hyperref[sec:ptc-printframes]{\tt PTC\_PRINTFRAMES}
   \item \hyperref[sec:ptc-select]{\tt PTC\_SELECT}
   \item \hyperref[sec:ptc-select-moment]{\tt PTC\_SELECT\_MOMENT}
   \item \hyperref[sec:ptc-moments]{\tt PTC\_MOMENTS} \qquad {\bf (Under Construction)} 
   \item \hyperref[sec:ptc-dumpmaps]{\tt PTC\_DUMPMAPS}
   \item \hyperref[sec:ptc-setcavities]{\tt PTC\_SETCAVITIES}
\end{itemize}
...
The \hyperref[sec:ptc-select]{\tt PTC\_SELECT} command 
...
\begin{enumerate}
   \item  written to a file with
     \hyperref[sec:ptc-printparametric]{\tt PTC\_PRINTPARAMETRIC}. 
   ...
   \item  used to rapidly obtain approximate values of lattice
     ...
     (\hyperref[sec:ptc-setknobvalue]{\tt PTC\_SETKNOBVALUE}). This
...
and the columns specified with \hyperref[sec:ptc-select]{\tt
...
\begin{madlist}
   ...
   \ttitem{FORMAT} specifies the format of geometry data.
	...
	\ttitem{rootmacro} creates \href{http://root.cern.ch}{\tt ROOT}
...
\href{http://cern.ch/frs/mad-X_examples/ptc_madx_interface/eplacement/eplacement.madx}{Dog
  leg chicane} with some elements displaced with help of {\tt PTC\_EPLACEMENT}.
...
\hyperref[sec:ptc-select-moment]{\tt PTC\_SELECT\_MOMENT} command.  It uses maps
saved by the \hyperref[sec:ptc-twiss]{\tt PTC\_TWISS} command, hence,
...
previously set in \hyperref[sec:ptc-setswitch]{\tt PTC\_SETSWITCH}.
...
of light.  Hence, if \ptc internal state {\tt TIME} is {\tt true}, which
is the most correct setting, the voltage seen by a particle is varying
along the structure. If {\tt TIME=false}, the tracked particle is
