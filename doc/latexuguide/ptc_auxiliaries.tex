...
\begin{itemize}
   ...
   \item \hyperref[sec:match_withptcknobs]{\tt MATCH\_WITHPTCKNOBS} \qquad {\bf (Under Construction)} 
...
and the columns specified with \hyperref[sec:ptc_select]{\tt
...
\begin{madlist}
   ...
   \begin{madlist}
     \ttitem{gauss} Gaussian distirbution (Default)
