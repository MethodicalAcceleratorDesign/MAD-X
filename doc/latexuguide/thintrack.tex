...
Only thin elements are allowed, with some exceptions: the element \texttt{drift}, and the elements \texttt{quadrupole} and \texttt{sbend} when the boolean flag \texttt{THICK} is set to true. The symplecticity of the coordinate transformation is guaranteed.
