...
\item[Twiss calculation is 4D only!]  The Twiss command will calculate
  ...
  \hyperref[chap:ptc-twiss]{\tt PTC\_TWISS} command.  The
...
\item[Dispersion for machines with small relativistic beta] 
  ...
  \hyperref{sec:ptc-twiss}{\tt PTC\_TWISS} command.  
...
\item[Non-standard definition of DDX, DDPX, DDY, DDPY] 
  ...
  of 2. The corresponding values from \hyperref[chap:ptc-normal]{\tt
    PTC\_NORMAL} and in \hyperref[chap:ptc-twiss]{\tt PTC\_TWISS} are
...
\item[\madx versus \ptc] 
  ...
  \hyperref[sec:ptc-twiss]{\tt PTC\_TWISS} due to the fact that
