...
\item[Twiss calculation is 4D only!]  The Twiss command will calculate
  ...
  an active \hyperref[sec:cavity]{cavity}. However, the calculation of
...
\item[\madx versus \ptc] 
  ...
  simple \hyperref[sec:twiss]{\tt TWISS} command executed before \ptc
...
\item[Validity of Twiss parameters]
  ...
  flag \hyperref[sec:twiss]{\tt TWISS} calculates the Mais-Ripken
