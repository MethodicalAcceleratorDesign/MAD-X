...
\begin{madlist}
  \ttitem{2017-Jun-27} version 5.03.06, 92a1be1a \\
  Can use sigma matrix elements as constraints.

  \ttitem{2017-Jun-27} version 5.03.06, 4d400c4c \\
  Add \texttt{SELECT, flag=interpolate} option to select positions for
  intermediate values during \texttt{TWISS}.

  \ttitem{2017-Jun-26} version 5.03.06, d028e6c5 \\
  Refactor and simplify \texttt{TWISS} code for \texttt{CENTRE}.

  \ttitem{2017-Jun-26} version 5.03.06, 73dc378b \\
  Decrease node size and avoid needless copies during matching.

  \ttitem{2017-Jun-26} version 5.03.06, 1e698ee1 \\
  Fix \texttt{INTERPOLATE} option of \texttt{PLOT}/\texttt{APERTURE} erasing expressions in elements (\#377,\#404).

  \ttitem{2017-Jun-23} version 5.03.06 \\
  Migrate MAD-X to github: \url{https://github.com/MethodicalAcceleratorDesign/MAD-X}

  \ttitem{2017-May-29} version 5.03.06 \\
  Fix cmake config for building with GC on windows.

  \ttitemn{2017-May-29} version 5.03.06, r6282 \\
 ...
 Move \texttt{PTC\_SETSWITCH} description right after \texttt{PTC\_CREATE\_LAYOUT}.
  ...
  \ttitemn{2017-Apr-11} version 5.03.00, r6188 \\
  Allow Track to specify a new seed for the quantum attribute.

  \ttitemn{2017-Apr-11} version 5.03.00, r6187 \\
