...
\begin{madlist}
  \ttitem{2015-Sep-15} version 5.02.07, r5407\\
  ...
  \ttitem{2015-Aug-31} version 5.02.07, r5367\\
...
%  {\bf (give reference to web page giving details for translation...)}
  ...
  removed the \hyperref[sec:global]{\tt GLOBAL} matching constraints
  {\tt DDQ1, DDQ2} from the documentation since they are not implemented in the code. 
  ...
  documented a bug occurring when \hyperref[sec:beamline]{\tt LINE}
  or \hyperref[sec:macro]{\tt MACRO} constructs appear within a
  \hyperref[sec:if]{\tt IF ... ELSEIF ... ELSE} or a 
  ...
  \hyperref[sec:setvars]{\tt SETVARS} and \hyperref[sec:setvars-lin]{\tt
