...
\textbf{Editor's Note:} This command exists but was not properly documented.\\
The file PTC\_PrintParametric.html contains the same content as
PTC\_Knob.html. I presume the original file has been lost and overwritten...

Prints parametric results obtained after issuing a ptc_knob command (see \hyperref{sec:ptc-knob}).
