...
\begin{madlist}
   ...
   \ttitem{PLANE} With {\tt PLANE=x}, the orbit correction
   ...
   \ttitem{COND} When {\tt COND=1}, a Singular Value Decomposition is
...
names like in \hyperref[chap:twiss]{\tt TWISS, TABLE=name;}. 
