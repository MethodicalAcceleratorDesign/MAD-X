...
The extracted sequence is declared as \hyperref[chap:sequence]{\tt SHARE}d and
...
%saves the sequence or sequences specified, with all variables and elements 
%%%needed for their expansion, onto the file given with the FILE argument.
\begin{5.02.06}
\madbox{
