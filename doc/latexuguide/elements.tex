...
\madbox{
label: OCTUPOLE, L=real, K3=real, K3S=real, TILT=real, KTAP=real;
}
...
%% K2S for sextupoles
   ...
   \ttitem{TILT} The roll angle about the longitudinal axis (default: 0
    ...
    \ttitem{KTAP} The relative change of the sextupole strengths (both
     \texttt{K3} and \texttt{K3S}) to account for energy change of the 
     reference particle due to RF cavities or synchrotron radiation. The
     actual strength of the sextupole is calculated as
     \texttt{K3act = K3 * (1 + KTAP)}.
     See the \texttt{TAPER} command.\ref{chap:taper}. (Default:~0) 
...
label: MULTIPOLE, \= LRAD=real, TILT=real, \\
                  \> KNL=\{real, \ldots \}, KSL=\{real, \ldots \}, KTAP=real;
}
...
%    the skew or vertical rotation angle of the thin dipole.
    ...
    \ttitem{KTAP} The relative change of the multipole strengths (both
     \texttt{KNL} and \texttt{KSL}) to account for energy change of the 
     reference particle due to RF cavities or synchrotron radiation. The
     actual strength of the multipole component is calculated as
     \texttt{Kact = K * (1 + KTAP)}. See the \texttt{TAPER}
     command.\ref{chap:taper}. (Default:~0) 
