...
\madbox{
label: TRANSLATION, \= X=real,  \= Y=real,  \= S=real;
}

\texttt{TRANSLATION} moves the coordinate system. \ttitem{X} and \ttitem{Y} will translate the position and \ttitem{S} will introduce a virtual drift. 
