...
\begin{madlist}
   ...
   \ttitem{K2} The sextupole coefficient. (Default: $0
   mˆ{-3}$) \\ $K_2 = (1/B\rho) (\partial^2 B_y / \partial x^2)$.   

   \ttitem{H1}The curvature of the entrance pole
   face. (Default: $0 m^{-1}$).   
...
% -orbit to positive y values.
   ...
   (Default: false)
   \ttitem{KILL\_ENT\_FRINGE} It this logical flag is set to true, the computation of the entrance fringe fields and pole-face effects will be omitted. This flag affects the modules TWISS and TRACK. \\
   (Default: false)
   
   \ttitem{KILL\_EXI\_FRINGE} It this logical flag is set to true, the computation of the exit fringe fields and pole-face effects will be omitted. This flag affects the modules TWISS and TRACK. \\
  (Default: false)
\end{madlist}
