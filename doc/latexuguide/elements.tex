...
\begin{madlist}
  ...
  \hyperref[subsec:local-rbend]{sbend reference system}.  
  \ttitem{RBEND}\label{bend-rbend} is a rectangular bending magnet. \\ 
...
\begin{madlist}
   ...
   \ttitem{HGAP} half gap height of the associated {\tt SBEND}
     \hyperref[bend-sbend]{Bending Magnet}.   
   \ttitem{TILT} The roll angle about the longitudinal axis (default: 0
...
%% K2S for sextupoles 
   ...
   \ttitem{TILT} The roll angle about the longitudinal axis (default: 0
     ...
     clockwise rotation. A {\tt TILT=pi/8} turns a positive normal octupole
...
\textit{ Note as well that Twiss is 4D only. As a consequence
  ...
  use the \hyperref[sec:ptc-twiss]{\tt PTC\_TWISS} command. } 
...
Users are STRONGLY advised to replaced all instances of {\tt RCOLLIMATOR} 
...
\begin{madlist}
   ...
   \ttitem{BBSHAPE} The parameter to choose the radial density shape of the 
     ...
     \begin{itemize}
       ...
       fig.\ref{fig:beambeam-n-trapez}), {\tt SIGX, SIGY}: half width of 
...
\end{figure}
       ...
       fig.\ref{fig:beambeam-n-hollowparabol}, {\tt SIGX, SIGY}: distance 
