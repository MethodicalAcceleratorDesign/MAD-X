...
An \texttt{RFMULTIPOLE} with no dipole component has no effect on the reference
orbit, \textit{i.e.} the reference system at the exit is the same as at the
entrance. If the \texttt{RFMULTIPOLE} includes a dipole component, it
has the same effect on the reference orbit as a thin \texttt{MULTIPOLE}
