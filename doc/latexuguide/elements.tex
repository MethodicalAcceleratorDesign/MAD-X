...
%irina 
\textbf{Note:} Quadrupoles doesn't carry any attributes of bending magnet or sextupole, i.e. $K_0$ or $K_2$t. In case these have to be considered in the element, please use bending magnet as a type of an element.
...
\textbf{Note:} Sextupole doesn't carry any attributes of bending magnet or quadrupole,
 ...
 bending magnet as a type of an element.
