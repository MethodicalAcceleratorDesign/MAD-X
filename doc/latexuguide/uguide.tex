...
\includeonly{
  ...
  ptc_general, ptc_track, ptc_track_line, ptc_twiss, ptc_normal, ptc_auxiliaries, 
  defects, pitfalls
 }
...
%\usepackage[pdftex]{graphicx} % Show image: \includegraphics[width=x]{file}.
...
\hypersetup{pdfauthor={Ghislain Roy},
	    ...
	    colorlinks,
            citecolor=blue, pagecolor=blue, linkcolor=blue}
...
\include{contributors}     %MAD-X contributors and module keepers
