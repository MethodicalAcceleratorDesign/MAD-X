...
Select, flag=twiss, column= \>name,s,betx,alfx,mux,bety,alfy,muy, \\
     ...
     and a subsequent TWISS command put the aperture information together with 
     the specified TWISS parameters into the TWISS table.
   ...
   \item The minimum beam stay-clear value (n1 value) computed along the 
     ...
     variable of the \hyperref[sec:beam]{\tt BEAM} command: 
\madxmp{
Value, beam->n1min;\\
nmin = beam->n1min;}
