...
\begin{madlist}
	...
	\begin{madlist}
		...
		a {\tt RECTANGLE} 
		\ttitem{LHCSCREEN} an alias for {\tt RECTCIRCLE}
		\ttitem{RECTELLIPSE} a superposition or intersection of 
		an {\tt ELLIPSE} and a {\tt RECTANGLE}
		\ttitem{RACETRACK} the union of an {\tt ELLIPSE} and a 
		{\tt RECTANGLE} forming a {\tt RACETRACK} shape 
		with four quarters of ellipse, one per quadrant, connected 
		by straight lines 
		\ttitem{OCTAGON} a simply connex octagon
	\end{madlist}
	If a filename is provided as argument, the file must contain a 
...
\begin{table}[ht]
	...
	\begin{tabular}{|l | c | p{8cm}|}
		...
		{\tt ELLIPSE} & 2 & horizontal and vertical semi-axes of ellipse \\  
		\hline
		{\tt RECTCIRCLE} or {\tt LHCSCREEN} & 3 & half width and half height 
		of rectangle, radius of circle\\
		\hline
		{\tt RECTELLIPSE} & 4 & half width and half height of rectangle, 
		horizontal and vertical semi-axes of ellipse \\
		\hline
		{\tt RACETRACK} & 4 & half width and half height along main axes, 
