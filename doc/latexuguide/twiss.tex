...
\hyperref[subsec:tables_linear]{linear lattice
  functions} \cite{Courant_Snyder1958}, and optionally the
\hyperref[subsec:tables_chrom]{chromatic functions}. 
...
\begin{madlist}
  ...
  \ttitem{CENTRE} a logical 
  flag to enforce the calculation of the
  \hyperref[subsec:tables_linear]{linear lattice
  ...
  \hyperref[subsec:tables_linear]{linear lattice functions} as well 
  as \hyperref[subsec:tables_chrom]{chromatic functions} are stored. 
  (Default: ``twiss'') \\
%  \madx creates a full
%  \hyperref[subsec:tables_linear]{Twiss table} in
