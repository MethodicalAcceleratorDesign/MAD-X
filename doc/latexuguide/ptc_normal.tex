...
\label{cgap:ptc_normal}


The {\tt PTC\_NORMAL} module (\cite{schmidt2005} and
\cite{damico2004_2}) of \madx is based on \ptc code. This module takes
...
PTC\_NORMAL, \=ICASE=integer, NORMAL=logical, CLOSED\_ORBIT=logical,\\ 
             \>NO=integer, MAP\_TABLE=logical, DELTAP=double;
}
...
\begin{madlist}
  ...
  can be used by the next \hyperref[chap:ptc_twiss]{\tt PTC\_TWISS}
