...
\begin{madlist}
   \ttitem{X, PX, Y, PY, T, PT} are the standard canonical
   coordinates. \\ (Default: 0.0)  

   \ttitem{FX, PHIX, FY, PHIY, FT, PHIT} are the action-angle
...
\begin{madlist}
  ...
  \\(Default: 4)
   ...
   \ttitem{ONETABLE} a logical switch to write all particle coordinates
