...
\label{sec:delete}
\madbox{
DELETE, SEQUENCE=sequencename, TABLE=tablename;
}
...
given in the PARAM attribute is the interpolation factor between 0 and
1. 

value = value(row1)*param + value(row2)*(1-param)


Internally, \madx constructs this as a deferred expression and evaluates it.
