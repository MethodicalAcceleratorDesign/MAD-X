...
{\bf Example:}\\ 
\madxmp{
SYSTEM,"ln -s /afs/cern.ch/user/u/user/public/some/directory shortname";
}
...
\madbox{
USE, PERIOD=sequence\_name, SEQUENCE=sequence\_name, RANGE=range, SURVEY=logical;
}
...
\begin{madlist}
  ...
  \ttitem{RANGE} specifies a \href{../Introduction/ranges.html#range}{range}.   
