...
based on the PTC code. It is a supplementary to the TWISS module. 
The Twiss parameters are calculated in Ripken's style (invented by 
G. Ripken in 1970 [31] and most accessible in
...
\item {\bf IGNORE\_MAP\_ORBIT}=logical (default: .false.) \\
...
\item {\bf RING\_PARAMETERS}=logical (default: .false.) \\
