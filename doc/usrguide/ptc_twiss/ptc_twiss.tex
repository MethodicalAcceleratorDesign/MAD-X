...
evaluating the chormaticities, the order must
...
\item {\bf FILE}[=string] (Default: .false.) \\
...
\item {\bf TABLE}[=string] (Default: .false.) \\
...
\item {\bf SUMMARY\_FILE}[=string] (Default: .false.) \\
...
\item {\bf SUMMARY\_TABLE}[=string] (Default: .false.) \\
...
\item {\bf MAP\_TABLE}=logical (Default: .false.)\\
