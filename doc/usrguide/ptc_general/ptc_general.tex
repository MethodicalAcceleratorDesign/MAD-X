...
\begin{description}
   ...
   \item[Description] 
     %  <strong>TRACK, DELTAP= double, ONEPASS, DUMP, ONETABLE, FILE=
     %  string;</strong> (MADX version 1)<br />  
     %     <strong>TRACK, DELTAP= double, ONEPASS, DAMP, QUANTUM, DUMP,
     %     ONETABLE, FILE= string;</strong> (MADX version 2)<br />  
...
\item[Remarks] 
  ...
  \textbf{MODEL}:\nolinebreak\nolinebreak  1 for "Drift-Kick-Drift"; 2
