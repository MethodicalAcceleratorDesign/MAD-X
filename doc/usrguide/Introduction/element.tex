...
\begin{itemize}
   \item L: The length of the monitor (default: 0 m). 
...
An instrumnet has one real attribute: 
\begin{itemize}
   \item L: The length of the instrument (default: 0 m). 
\end{itemize} 
