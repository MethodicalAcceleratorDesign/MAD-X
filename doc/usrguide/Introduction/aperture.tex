...
\begin{madlist}
  ...
  preselected types:
    \begin{madlist}
      ...
      \ttitem{RECTANGLE} 
      \ttitem{ELLIPSE} 
      \ttitem{LHCSCREEN} is a superposition of a CIRCLE and
        a RECTANGLE 
      \ttitem{MARGUERITE} is composed of two LHCSCREENS, one rotated by 90
        degrees  
      \ttitem{RECTELLIPSE} is a superposition of an ELLIPSE and a
        RECTANGLE
      \ttitem{RACETRACK} is a circle exploded in four with
