...
\begin{madlist}
   ...
   \ttitem{CHROM} A logical flag. If set, MAD-X also computes the
   ...
   \ttitem{FILE} If FILE="file\_name" appears MAD-X writes a full TFS
   ...
   \ttitem{TABLE} (overrides SAVE): MAD-X creates a full
   ...
   \ttitem{CENTRE} This flag enforces the calculation of the
   ...
   \ttitem{COUPLE} (obsolete) This MAD8 option can no
