...
" "
"split: control none 0 0 "
"sequence = [s, none, none], "
"newname1 = [s, none, none], "
"newname2 = [s, none, none], "
"to       = [s, none, none], "
"from     = [s, none, none]; "
...
"calib    = [r, 0], "
"polarity = [r, 0], "
"assemblyname1 = [s, none], "
"assemblyname2 = [s, none], "
"beamseparation = [r, 0], "
"model           = [i, -1], "
"method          = [i, -1], "
"exact           = [i, -1, 1], "
...
"bisec   = [i, 1], "
"cond    = [r, 1E-8], "
"knobfile = [s, knobs.madx, knobs.madx], "
"jacfile  = [s, jacobian.data, jacobian.data], "
"strategy = [i, 3]; "
" "
