module beam_beam_ptc
  ...
  private TRACK_NODE_LAYOUT_FLAG_Beam_R
  ...
  INTERFACE track_bb
     ...
     MODULE PROCEDURE TRACK_NODE_LAYOUT_FLAG_Beam_R
  END INTERFACE
...
!!!!!!!!!!!!!!!  track single node !!!!!!!!!!!!!!!
  ...
  SUBROUTINE TRACK_NODE_LAYOUT_FLAG_Beam_R(R,b,I1,I2,k) ! Tracks double from i1 to i2 in state k
    IMPLICIT NONE
    TYPE(layout),INTENT(INOUT):: R
  ...
  END SUBROUTINE TRACK_NODE_LAYOUT_FLAG_Beam_R
