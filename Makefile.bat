...
lf95 -c -o1 -tp %MADX%\plot.f90
lf95 -c -o1 -tp %MADX%\sodd.f90
lf95 -c -o1 -tp %MADX%\gxx11ps.f90
lf95 -c -o1 -tp %MADX%\dynap.f90
lf95 -c -o1 -tp %MADX%\emit.f90
lf95 -c -o1 -tp %MADX%\twiss.f90
lf95 -c -o1 -tp %MADX%\match.f90
lf95 -c -o1 -tp %MADX%\matchjc.f90
lf95 -c -o1 -tp %MADX%\matchlib.f90
lf95 -c -o1 -tp %MADX%\matchsa.f90
lf95 -c -o1 -tp %MADX%\touschek.f90
lf95 -c -o1 -tp %MADX%\poisson.f90
lf95 -c -o1 -tp %MADX%\survey.f90
lf95 -c -o1 -tp %MADX%\trrun.f90
lf95 -c -o1 -tp %MADX%\util.f90
lf95 -c -o1 -tp %MADX%\orbf.f90
lf95 -c -o1 -tp %MADX%\ptc_dummy.f90
lf95 -c -o1 -tp %MADX%\ibsdb.f90
lf95 -c -o1 -tp %MADX%\resindex.f90
...
lf95 -c -o1 -tp %FPP%\Sma0_beam_beam_ptc.f90
...
lf95 -c -o1 -tp %MADX%\ptc_export_xml.f90
...
lf95 -out %user_main%\madx madx_main.obj run_madx.obj madxp.obj matchptcknobs.obj rplot.obj dynap.obj emit.obj twiss.obj match.obj matchjc.obj matchlib.obj matchsa.obj touschek.obj survey.obj trrun.obj util.obj orbf.obj ibsdb.obj resindex.obj plot.obj sodd.obj gxx11ps.obj gxx11psc.obj a_scratch_size.obj b_da_arrays_all.obj c_dabnew.obj d_lielib.obj h_definition.obj i_tpsa.obj j_tpsalie.obj k_tpsalie_analysis.obj l_complex_taylor.obj m_real_polymorph.obj n_complex_polymorph.obj o_tree_element.obj Sa_extend_poly.obj Sb_sagan_pol_arbitrary.obj Sc_euclidean.obj Sd_frame.obj Se_status.obj Sf_def_all_kinds.obj Sg_sagan_wiggler.obj Sh_def_kind.obj Si_def_element.obj Sk_link_list.obj Sl_family.obj Sm_tracking.obj Sma0_beam_beam_ptc.obj Sma_multiparticle.obj Sn_mad_like.obj So_fitting.obj Sp_keywords.obj Spb_fake_gino_sub.obj Sq_orbit_ptc.obj Sqb_accel_ptc.obj Sr_spin.obj Sra_fitting.obj madx_ptc_intstate.obj madx_ptc_setcavs.obj madx_ptc_knobs.obj madx_ptc_module.obj St_pointers.obj madx_ptc_script.obj madx_ptc_eplacement.obj madx_ptc_distrib.obj madx_ptc_normal.obj madx_ptc_twiss.obj madx_ptc_track_run.obj madx_ptc_trackcavs.obj ptc_export_xml.obj wrap.obj user2_photon.obj poisson.obj timest.obj timex.obj %WRAPPERS_OBJ%
