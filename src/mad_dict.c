...
"h2       = [r, 0],  "
"hgap     = [r, 0],  "
"f1       = [r, 0],  " // jg: PTC FRINGE2QUAD
"f2       = [r, 0],  " // jg: PTC FRINGE2QUAD
"fint     = [r, 0, 0.5],  "
"fintx    = [r, -1.0], "
"fringe_max    = [i, 2],  " // jg: PTC MULT_FRINGE
"k3       = [r, 0],  "
"k3s      = [r, 0],  "
"ktap     = [r, 0],  "
"fcsr     = [r, 0],  "
...
"k1       = [r, 0],  "
"k1s      = [r, 0],  "
"e1       = [r, 0],  " // jg: PTC FRINGE_STREX
"e2       = [r, 0],  " // jg: PTC FRINGE_STREX
"f1       = [r, 0],  " // jg: PTC FRINGE2QUAD
"f2       = [r, 0],  " // jg: PTC FRINGE2QUAD
"h1       = [r, 0],  " // jg: PTC FACE
"h2       = [r, 0],  " // jg: PTC FACE
"fint     = [r, 0, 0.5],  " // jg: PTC BEND_FRINGE
"fintx    = [r, -1.0], "    // jg: PTC BEND_FRINGE
"hgap     = [r, 0],  "      // jg: PTC BEND_FRINGE
"fringe_max    = [i, 2],  " // jg: PTC MULT_FRINGE
"ktap     = [r, 0],  "
"mech_sep = [r, 0], "
"v_pos = [r, 0], "
...
"h1       = [r, 0],  " // jg: PTC FACE
"h2       = [r, 0],  " // jg: PTC FACE
"fint     = [r, 0, 0.5],  " // jg: PTC MULT_FRINGE
"fintx    = [r, -1.0], "    // jg: PTC MULT_FRINGE
"hgap     = [r, 0],  "      // jg: PTC BEND_FRINGE
"fringe_max    = [i, 2],  " // jg: PTC MULT_FRINGE
"ktap     = [r, 0],  "
"mech_sep = [r, 0], "
