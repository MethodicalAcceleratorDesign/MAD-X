...
subroutine ttmult(track,ktrack,dxt,dyt,turn)
  ...
  double precision :: bet_sqr, f_damp_t, f_damp_l
...
101  n_ferr = 2*n_ferr + 2
  ...
  if (radiate .and. elrad .ne. 0) then
     ...
     if (damp) then
        ...
        TRACK(6,:ktrack) = TRACK(6,:ktrack) * f_damp_l;
     endif
  endif
