...
!----------------------------------------------------------------------*
      ...
      double precision el,track(6,*),node_value,get_value,get_variable 
      double precision ex,ey,tilt,charge,mass,pc,beta,deltap,kick0
...
!      include 'bb.fi'
      ...
      logical aperflag, onepass, doupdate
      integer pmax, turn, turnmax, part_id(1),last_turn(1)
      double precision sum, tmp_d, spos, orbit(6)
