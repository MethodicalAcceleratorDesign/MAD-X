...
class subroutine: # Fortran subroutine related information
    ...
    def __init__(self,file,name,argString):           
        self.name = name
    ...
    for line in concatenatedLines:
        ...
        if state == lookForSubroutine:
            ...
            if m:
                ...
                res_index = subroutine(file,"res_index","skew,mynorder,myn1,myn2,indexa,mynres")
            ...
            if m:             
                ...
                arguments = m.group(2)
                newSubroutine = subroutine(file,name,arguments) # BUG: arguments names are lowered
                ...
                if m:
                    name = m.group(1)
                    arguments = ''
                    newSubroutine = subroutine(file,name,arguments)
