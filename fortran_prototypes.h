...
void svddec_m_(double* a,double* svdmat,double* umat,double* vmat,double* wmat,double* utmat,double* vtmat,double* wtmat,double* ws,double* wvec,int* sortw,int* im,int* ic,int* iflag,int* sing,int* dbg);
/* Wrap 'svddec_c' defined in 'orbf.F'*/
void svddec_c_(double* a,double* svdmat,double* umat,double* vmat,double* wmat,double* utmat,double* vtmat,double* wtmat,double* ws,double* wvec,int* sortw,int* im,int* ic,int* iflag,int* sing,int* dbg);
...
void w_ptc_twiss_(int* tab_name);
...
void res_index_(int* skew,int* mynorder,int* myn1,int* myn2,int* indexa,int* mynres);
/* Wrap 'soddin' defined in 'sodd.F'*/
void soddin_(int* ierr);
/* Wrap 'twiss' defined in 'twiss.F'*/
void twiss_(double* rt,double* disp0,int* tab_name);
